...
export type InstrumentId = 'lead' | 'drums' | 'bass' | 'pad'
...
export const LEAD_PRESETS = ['neon', 'glass', 'saw'] as const
export const BASS_PRESETS = ['warm', 'growl', 'sub'] as const
export const PAD_PRESETS = ['haze', 'strings', 'choir'] as const
export const DRUM_PRESETS = ['analog', 'punch'] as const
